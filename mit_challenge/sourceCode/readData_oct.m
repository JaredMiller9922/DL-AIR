...
% Converts from [i0,q0,i1,q1] -> [c0, c1] the iqdata pairs each become one complex value
...
% Output data has shape (Nr, Nsamples) so Y[0, :] is the complex samples for antenna r
